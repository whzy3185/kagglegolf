...
from neurogolf.onnx_build import build_size_two_object_outbox_network
...
def main() -> None:
    ...
    parser.add_argument("--object-color", type=int, default=2)
    parser.add_argument("--outbox-color", type=int, default=3)
    parser.add_argument("--output", required=True)
    args = parser.parse_args()

    output = ROOT / args.output
    build_size_two_object_outbox_network(
        output,
        object_color=args.object_color,
        outbox_color=args.outbox_color,
    )
