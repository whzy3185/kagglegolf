...
from neurogolf.onnx_build import build_valid_axis_reverse_network
...
def main() -> None:
    ...
    parser.add_argument("--axis", type=int, choices=[2, 3], required=True)
    parser.add_argument("--output", required=True)
    args = parser.parse_args()

    output = ROOT / args.output
    build_valid_axis_reverse_network(output, axis=args.axis)
