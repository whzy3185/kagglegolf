...
from neurogolf.onnx_build import build_fixed_3x3_rotation_network
...
def main() -> None:
    ...
    parser.add_argument("--rotation", required=True, choices=["rot180", "rot270"])
    parser.add_argument("--output", required=True)
    args = parser.parse_args()

    output = ROOT / args.output
    build_fixed_3x3_rotation_network(output, rotation=args.rotation)
